...
namespace riode_backend.Migrations
{
    ...
    [Migration("20240501145537_NewProductImage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("riode_backend.Models.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("riode_backend.Models.BlogTopic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("riode_backend.Models.Settings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("riode_backend.Models.Topic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("riode_backend.Models.BasketItem", b =>
                {
                    b.HasOne("riode_backend.Models.AppUser", "AppUser")
                        .WithMany()
            ...
            modelBuilder.Entity("riode_backend.Models.BlogTopic", b =>
                {
                    b.HasOne("riode_backend.Models.Blog", "Blog")
                        .WithMany("BlogTopic")
                        .HasForeignKey("BlogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("riode_backend.Models.Topic", "Topic")
                        .WithMany("BlogTopic")
